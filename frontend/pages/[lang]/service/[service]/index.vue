...
const dataInfoText = (servicePageData.value?.data?.Subtitle && servicePageData.value?.data?.SubDescription) ? {
  Title : servicePageData.value?.data?.Subtitle,
  Description : servicePageData.value?.data?.SubDescription
} : null;
      ...
      <div class="wrap">
        <div class="content">
          ...
          <div class="booking" v-if="servicePageData?.data?.booking">
            ...
            <div class="action" v-if="servicePageData?.data?.booking?.Action && servicePageData?.data?.booking?.Action?.Url !== '#'">
