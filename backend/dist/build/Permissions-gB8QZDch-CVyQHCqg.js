...
`,Is=k.forwardRef(({onClick:e,className:s,hasConditions:o=!1,variant:n="tertiary"},r)=>{const{formatMessage:a}=P();return t.jsx(Ns,{$hasConditions:o,className:s,children:t.jsx(ie,{variant:n,startIcon:t.jsx(Ue,{}),onClick:e,ref:r,type:"button",children:a({id:"global.settings",defaultMessage:"Settings"})})})}),Ns=T(O)`
